  ...
  return (
    <View style={stylePageArticle.container}>
      ...
      <View style={stylePageArticle.styleImage}>
        <Image
          style={stylePageArticle.styleImageContent}
          source={props.image}
        />
      </View>
      <View style={stylePageArticle.styleTitle}>
        <Text style={stylePageArticle.styleTitleContent}>
          {props.introContent}
        </Text>
      </View>
      <View style={stylePageArticle.styleContent}>
        <Text style={stylePageArticle.styleContentArticle}>
          {props.introTitle}
        </Text>
        <TouchableOpacity
          onPress={() => {
          ...
          {props.isShow === 'true' ? (
            <Text style={stylePageArticle.styleButton}>login</Text>
          ) : null}
        </TouchableOpacity>
      </View>
    </View>
  ...
  return (
    <SafeAreaView style={stylesIntro.containr}>
      <View style={stylesIntro.containr}>
        <ImageBackground
          style={stylesIntro.styleBackground}
          source={IntroBacnground}>
